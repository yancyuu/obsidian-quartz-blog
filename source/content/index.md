...
- **🤖 Agent框架**： 
	...
	- Pydantic AI：类型安全，代码更优雅，支持依赖注入和工具书自动调用。
	- AutoGen: 玩具。
	- ADK：轻量的玩具。
	- Openai SDK：轻量，但是依赖生态，需要自己写的东西太多了。
	- Camel：多Agent协同框架，主打一个认知流，很适合科研或者开放型的Agent构建。
	- Agno:  极致的性能，主打一个速度快，使用方便，目前最喜欢的Agent框架。
- 🧸 **LLMdops**：
	- dify：也是最早用的，做demo可以，后端是同步的，并发有很大问题，分片部署才稳定。
	- fastgpt： 还行，技术栈代码好二开，知识库一般般。
	- n8n：挺好，并发好，可以并行，适合开发用，快速验证一些想法，快速商业化首选。
